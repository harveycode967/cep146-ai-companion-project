...
To be completed after the video is public and both AI evaluations have been run. Each section below is a prompt for what to write, not final text.

### A1. AI Model 1 Summary

Which model was used and its version if known. The score it suggested for each of the four rubric categories. What it said we did well. What it said to improve.

### A2. AI Model 2 Summary

The same again for the second model.

### A3. Comparison

Where the two models agreed and where they split. If one gave noticeably better feedback than the other, which one and why we think that was.

### A4. Do You Agree With the AI's Grade?

Whether the suggested grade felt fair, anything that surprised us, and anything the AI got wrong or misread about the project.

### A5. What Would You Do Differently?

What we would actually change based on the feedback, and at least one suggestion we are choosing not to act on, with the reason.
